#https://www.kaggle.com/pythonomic/march-machine-learning-mania-2016/elo-rating-try-new
...
for index, row in preds.iterrows():
    ...
    prediction[i] = 0.5 + (team[p[1]] - team[p[2]]) / 480
    i += 1

preds['Pred'] = np.clip(prediction, 0.05, 0.93)
