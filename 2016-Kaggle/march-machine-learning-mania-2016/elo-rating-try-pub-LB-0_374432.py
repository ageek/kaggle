#https://www.kaggle.com/dmytrolystopad/march-machine-learning-mania-2016/elo-rating-try/code
...
for index, row in preds.iterrows():
    ...
    prediction[i] = 0.5 + 0.4*(team[p[1]] - team[p[2]]) / 480 + 0.6*(team2[p[1]] - team2[p[2]])/520
    i += 1
