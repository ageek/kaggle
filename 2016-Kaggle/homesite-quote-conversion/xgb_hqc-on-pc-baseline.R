...
save(clf, file="./xgb_stop_1_50k-validation_win7_10krounds-baseline-1_eta_0_01_mdep_6.rda")
...
write_csv(submission, "xgb_stop_1_50k-validation__win7_10krounds_eta_0.01_mdep_6.csv")
